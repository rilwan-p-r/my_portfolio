            ...
            <motion.div
                ...
                <motion.div
                    ...
                    <p className='mb-10 max-w-2xl font-Ovo'>
                        I am an experienced Full Stack Developer with over a decade of professional expertise in the field.
                    ...
                    <motion.h4
                        ...
                        className='my-6 text-gray-500 font-Ovo dark:text-white/80'>Tools I use</motion.h4>
                    ...
                    <motion.ul
                        ...
                        {toolsData.map((tool, index) => (
                            <motion.li
                                ...
                                key={index}
                                className='flex items-center justify-center w-12 sm:w-14 aspect-square border border-gray-400 rounded-lg cursor-pointer hover:-translate-y-4 duration-500 hover:shadow-lg hover:shadow-black'>
                                <Image
                                    src={tool.src}
                                    alt={tool.alt}
                                    width={28}
