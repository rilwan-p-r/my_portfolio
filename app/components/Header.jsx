    ...
    return (
        <div id='home' className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
            ...
            <motion.h1
                ...
                Full Stack Software Engineer building seamless experiences.
            </motion.h1>
            <motion.p
                initial={{ opacity: 0 }}
                ...
                I am a software engineer with 2 years of hands-on experience in creating scalable and efficient web applications.
            </motion.p>
            <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
                <motion.a
                    ...
                    items-center gap-2 font-Outfit dark:bg-transparent'>
                ...
                <motion.a
                    ...
                    href='/Rilwan_Resume.pdf' download
