    ...
    return (
        <motion.div
            ...
            <motion.p
                ...
                Welcome to my portfolio! Here, you can explore a selection of my latest projects that showcase my skills and expertise in web development. Each project reflects my commitment to delivering high-quality solutions that meet the needs of my clients. I invite you to take a look at my work and see how I can help bring your ideas to life.
            </motion.p>
        ...
        py-3 px-5 flex items-center justify-between duration-500 group-hover:bottom-7'>
                            <div>
                                ...
                                <p
                                    className={`text-sm text-gray-700 overflow-hidden ${expandedIndex === index ? '' : 'line-clamp-2'}`}
                                >
                                    {project.description}
                                    {expandedIndex !== index && (
                                        <span
            ...
            <motion.a
                ...
                href="https://github.com/rilwan-p-r"
                target="_blank"
